...
func runCLI() {
    command(
        ...
        Flag("legacyParser", description: "Use SourceKitten rather than SwiftSyntax"),
    ...
    ) { watcherEnabled, disableCache, verboseLogging, logAST, logBenchmark, quiet, prune, legacyParser, sources, excludeSources, templates, excludeTemplates, output, configPath, forceParse, args, ejsPath in
        do {
            ...
            parserEngine = legacyParser ? .sourceKit : .swiftSyntax
